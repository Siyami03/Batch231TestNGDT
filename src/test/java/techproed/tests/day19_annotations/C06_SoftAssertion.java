...
public class C06_SoftAssertion {
        ...
        //Test methodu olustur, softAssert objesi olustur, obje ile çeşitli testler yap
        ...
        /*SoftAssert'un hata bulsa bile calismaya devam etme özelligi assertAll()' a kadardir. Eger assertAll() da fail
        rapor edilirse calisma durdurulur, ve classin kalan kismi calistirilmaz         */
    }
}
