...
public class P02 {
    ...
    @Test(description = "US001 - AC02 registration page should be able to register the user")
    public void registrationTest() {

        //https://demo.automationtesting.in/Register.html adresine gidin
        Driver.getDriver().get(ConfigReader.getProperty("demoUrl"));
        ExtentReportUtils.extentTestInfo("https://demo.automationtesting.in/Register.html adresine gidildi");
