...
public class Driver {
    ...
    /*Webdriver tipinde bir ThreadLocal objecti olusturduk, bu sayede PARALEL TEST yaparken her threadin kendi webdriver
      objectine sahip olmasini sagladik, Böylece paralel olarak calisan farkli threadlerin birbirini etkilemesini
      önledik     */
