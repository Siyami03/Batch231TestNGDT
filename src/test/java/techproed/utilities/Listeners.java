...
public class Listeners implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
    ...
    /*Bu method bir test methoduna bir RetryAnalyzer eklemek icin kullanilir. Listeners classindaki retry methodunu yani
    yukarida yazmis oldugumuz methodu RetryAnalyzer olarak ayarlar. Bu sayede test fail oldugu zaman Listeners
    clasimizdaki bu retry methodu cagrilir ve yukaridaki tekar calistirma uygulanmis olacak   */
